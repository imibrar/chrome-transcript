                ...
                Rr(
                    ...
                    [
                        Nr(
                            ...
                            [fo(n.$slots, "trigger", {}, () => [o[2] || (o[2] = zr("Наведи на меня", -1))])],
                            34,
                        ),
                        e.isShow & t.value
                            ? (Tr(), Rr("div", { key: 0, class: K([Rt(rl)["vtt-tooltip"], Rt(rl)[`vtt-tooltip--${e.position}`]]) }, [fo(n.$slots, "content", {}, () => [o[3] || (o[3] = zr("Это tooltip!", -1))])], 2))
                            : $r("", !0),
                    ],
                    2,
                )
